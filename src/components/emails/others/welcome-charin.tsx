...
interface WelcomeEmailCharinProps {
...
export default function WelcomeEmailCharin({
	clientId,
	org_name,
	accountLink,
	paymentWindowDays = 14,
}: WelcomeEmailCharinProps) {
	return (
		<Html>
			<Head>
				<meta
			...
			<Preview>Welcome to POE – Your account is active</Preview>
				...
				>
					...
					>
						<Section>
							...
							<Text style={paragraph}>
								Welcome to POE — your account is now{' '}
								<strong>active</strong>. You have{' '}
								<strong>{paymentWindowDays} days</strong> to
								complete the subscription payment to keep
								uninterrupted access.
							</Text>
							<Text style={paragraph}>
								Our team will contact you shortly with payment
								details and onboarding guidance. Meanwhile you
								can explore your account and review your
								selection.
							</Text>
							<Text style={paragraph}>
...
// Styles (CharIN brand, mirroring freeze-notice-charin)
