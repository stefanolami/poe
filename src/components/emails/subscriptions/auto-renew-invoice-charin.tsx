...
export default function AutoRenewInvoiceCharinEmail({
	clientId,
	subscriptionId,
	org_name,
	previewText = 'Subscription Renewal — Action Needed',
	accountLink,
}: Props) {
	return (
		<Html>
				...
				>
					...
					>
						<Section>
							...
							<Text style={paragraph}>
								Your subscription has reached the end of its
								term and is now pending renewal for up to 14
								days while we await payment. Please complete
								payment to keep your access and alerts active
								without interruption.
							</Text>
							<Text style={paragraph}>
								If you need an invoice copy or assistance,
								please write to{' '}
								<Link
								...
								and we’ll help you promptly.
							</Text>
							<Text style={{ ...paragraph, color: '#666' }}>
							...
							>
								<tbody>
									<tr>
										...
										>
											<Link
												href="https://www.charin.global/contact/"
												style={ctaButton}
												target="_blank"
						...
						{/* Footer (same as account-recap-charin) */}
