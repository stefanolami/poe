...
export default function SelectionReminderEmail({
	...
	days,
	org_name,
	previewText = 'Reminder: Pending Selection Change',
	accountLink,
}: Props) {
	return (
		<Html>
				...
				>
					...
					<Section style={gradientHeader}>
						...
						<Row>
							...
							>
								...
								>
									REMINDER: SELECTION CHANGE PENDING
								</Text>
							</Column>
						</Row>
						<Row>
					...
					>
						<Section>
							...
							<Text style={paragraph}>
								This is a friendly reminder that your selection
								change is still pending. Please complete your
								payment within {days} days to ensure the changes
